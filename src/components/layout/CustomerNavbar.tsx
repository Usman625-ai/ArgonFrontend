          ...
          <div className="flex shrink-0 items-center gap-0.5 sm:gap-1">
            ...
            {isAuthenticated ? (
              ...
              <div className="ml-1 hidden items-center gap-2 sm:flex">
                <Link to="/login" className="rounded-lg px-3 py-2 text-sm font-medium text-foreground/80 transition-colors hover:text-foreground">Login</Link>
                <Link to="/register" className="rounded-full bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90">Sign Up</Link>
              </div>
            )}
          </div>
        </div>
          ...
          <motion.div initial={{ x: '-100%' }} animate={{ x: 0 }} exit={{ x: '-100%' }} transition={{ type: 'tween', duration: 0.3 }} className="fixed left-0 top-0 z-50 h-screen w-72 border-r border-border bg-card p-4 lg:hidden">
            ...
            {!isAuthenticated && (
              <div className="mt-4 space-y-2 border-t border-border pt-4">
                <Link to="/login" className="block rounded-lg border border-border px-3 py-2.5 text-center text-sm font-medium hover:bg-accent">Login</Link>
                <Link to="/register" className="block rounded-lg bg-primary px-3 py-2.5 text-center text-sm font-medium text-primary-foreground hover:opacity-90">Sign Up</Link>
              </div>
            )}
          </motion.div>
        </>}
