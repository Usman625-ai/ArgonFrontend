        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <span className="flex items-center gap-2">
              ...
              <span className="font-editorial text-xl font-medium tracking-tight">Argon</span>
            </span>
            ...
            <div className="mt-5 flex gap-2">
              ...
              <a href="https://www.instagram.com/_usmanhussainn?igsh=MWlqa2l4a3pscTNhdA==" className="rounded-md border border-border p-2 text-muted-foreground transition-colors hover:border-primary/40 hover:text-primary"><Instagram className="h-4 w-4" /></a>
            </div>
          </div>
          ...
          <div><h3 className="eyebrow">Contact</h3><ul className="mt-4 space-y-3 text-sm"><li className="flex items-center gap-2 text-muted-foreground"><Mail className="h-4 w-4 text-primary" /> mrusmanhussain101@gmail.com</li><li className="flex items-center gap-2 text-muted-foreground"><Phone className="h-4 w-4 text-primary" /> +92 33535 80298</li><li className="flex items-center gap-2 text-muted-foreground"><MapPin className="h-4 w-4 text-primary" /> Karachi, Pakistan</li></ul></div>
        </div>
      </div>
